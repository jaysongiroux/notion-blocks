...
import { CodeProps, ThemeEnum } from "../../types/code";
  ...
  const hoverableToolbar = (
    <>
      ...
      <div className="CodeCopyButtonContainer">
        <button className="CodeCopyButton" onClick={handleCopyClick}>
          {copied ? (
            <>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="CodeCopyButtonIcon CodeCopyButtonIconCopied"
                height="12px"
                width="12px"
    ...
    return (
      <>
        <div className="CodeContainer" style={props?.codeStyles}>
          {props?.codeOverlay && hoverableToolbar}
          <SyntaxHighlighter
            customStyle={{
              fontSize: "12px",
              paddingTop: props?.codeOverlay ? 25: 10,
              paddingBottom: props?.codeOverlay ? 25: 10,
            }}
            language="javascript"
