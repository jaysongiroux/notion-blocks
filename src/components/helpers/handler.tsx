...
const HandleComponent = (props: HandleComponentProps) => {
	...
	switch (block?.type) {
		...
		case "heading_1":
			return (
				<Headers
					headerStyles={additionalProps?.headerStyles}
		...
		case "paragraph":
			return (
				<Paragraph
					paragraphStyles={additionalProps?.paragraphStyles}
		...
		case "image":
			return (
				<Picture
					...
					pictureStyles={additionalProps?.pictureStyles}
				/>
			);
		case "callout":
			return (
				<Callout
					calloutStyles={additionalProps?.calloutStyles}
		...
		case "quote":
			return (
				<Quote
					quoteStyles={additionalProps?.quoteStyles}
		...
		case "bulleted_list_item":
			return (
				<BulletList
					listStyles={additionalProps?.listStyles}
		...
		case "bookmark":
			return (
				<Bookmark
					...
					bookmarkStyles={additionalProps?.bookmarkStyles}
				/>
			);
		default:
			return null;
